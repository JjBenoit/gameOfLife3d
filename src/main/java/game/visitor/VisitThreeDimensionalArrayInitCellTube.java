...
public class VisitThreeDimensionalArrayInitCellTube extends AbstractVisitThreeDimensionalArray {

    private static final Logger LOGGER = LogManager.getLogger(VisitThreeDimensionalArrayInitCellTube.class);

    // la grille est considérée comme un plan en 3D à bords : haut et bas. avant et
    // arriere
