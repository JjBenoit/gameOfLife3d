...
public class VisitThreeDimensionalArrayInitCellTor extends AbstractVisitThreeDimensionalArray<Cell>
{

    private static final Logger LOGGER = LogManager.getLogger(VisitThreeDimensionalArrayInitCellTor.class);

    public VisitThreeDimensionalArrayInitCellTor(Cell[][][] grid)
    {
        super(grid);
    }
